	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/cooperate/show/id/186' || $vo['href'] == $self) echo 'active'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/cooperate/index/ce/term_id/va/43">合作流程 > <?php echo ($ress["post_title"]); ?></a>
	</div>
