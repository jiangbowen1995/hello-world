	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/cooperate/index/ce/term_id/va/43' || $vo['href'] == $self) echo 'in'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/cooperate/index/ce/term_id/va/43">合作流程</a>
		>
	</div>
	<div class="main right">
		<div class="list">
			<h2>合作流程</h2>
			<div class="content">
			<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><a href="/index.php/Jlhyhome/cooperate/show/id/<?php echo ($vo['id']); ?>">	★ <?php echo ($vo['post_title']); ?></a><br><?php endforeach; endif; ?>
			</div>
			<div class="pager"></div>
		</div>
	</div>
