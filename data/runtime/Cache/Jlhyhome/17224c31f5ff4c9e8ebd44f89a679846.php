	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/design/index/ce/term_id/va/36' || $vo['href'] == $self) echo 'in'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/design/index/ce/term_id/va/36">设计方案</a>
		>
	</div>
	
	<div class="main right">
		<div class="catelog">
		<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><div class="item clearfix">
				<div class="left cate-name" >
					<div class="left text" style="padding:0px;height:130px">
						<a href="/index.php/Jlhyhome/design/show/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['post_title']); ?></a>
					</div>
					<dir class="right img"><a href="/index.php/Jlhyhome/design/show/id/<?php echo ($vo['id']); ?>"><img src="<?php echo sp_get_image_preview_url($vo['arr']['thumb']);?>" style="width:143px;height:130px" class="sheji"/></a></dir>
				</div>
				<div class="right tabs">
					<div class="head clearfix">
						<ul>
							<li class="active">
								<a href="/index.php/Jlhyhome/design/show/id/<?php echo ($vo['id']); ?>">简介</a>
							</li>
						</ul>
					</div>
					<div class="cons">
...
$().ready(function(e) {
    ...
    $(".tabs .head ul li").each(function(i, e) {

        $(e).mouseover(function(e1) {

			$(e).addClass("active").siblings().removeClass("active");

            $(".tabs .cons .con").eq(i).show().siblings().hide();
...
// 	//alert(self);
// 	location.href= "/index.php/Jlhyhome/design/show/name/99999";
// })
</script>
</body>
</html>
