	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/about/index/ce/term_id/va/44' || $vo['href'] == $self) echo 'in'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/about/index/ce/term_id/va/44">关于我们</a>
		>
	</div>
