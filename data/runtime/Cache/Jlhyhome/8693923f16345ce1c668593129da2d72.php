	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/news/index/ce/term_id/va/46' || $vo['href'] == $self) echo 'active'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/news/index/ce/term_id/va/46">新闻</a>
		>
	</div>
	<div class="main right">
		<div class="list">
			<h2>新闻</h2>
			<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><li style="margin-left:10px"><a href="/index.php/Jlhyhome/news/show/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['post_title']); ?></a></li><?php endforeach; endif; ?>
			
		</div>
		<div id="kk"><span id="kkk"><?php echo ($page); ?></span></div>
	</div>
