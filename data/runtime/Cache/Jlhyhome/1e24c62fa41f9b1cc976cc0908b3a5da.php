	...
	<div class="wrap">
		<div class="navigation left">
			...
			<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="home">
					<a href="<?php echo ($vo['href']); ?>" class="<?php if($vo['href'] == '/index.php/Jlhyhome/news/show/id/176' || $vo['href'] == $self) echo 'active'?>"><?php echo ($vo['label']); ?></a>
...
<div class="wrap clearfix contain">
	<div class="bread-crumb">
		...
		<a href="/index.php/Jlhyhome/news/index/ce/term_id/va/46">公司新闻 > <?php echo ($ress["post_title"]); ?></a>
	</div>
